...
<div {{ $attributes->merge(['class'=>'']) }}>
    ...
    <div class="mt-3 dark:text-white">
        @foreach ($matches as $match )
            <a target="_blank" href="{{ $match->live_link }}" class="flex w-full px-1 py-2 mb-2 bg-white border border-gray-200 rounded-lg shadow hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700">
