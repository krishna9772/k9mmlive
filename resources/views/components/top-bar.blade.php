<!-- Top Bar -->
<div id="top-bar" class="items-center justify-between px-6 py-2 text-sm bg-gray-100 dark:bg-gray-900">
    <div class="flex justify-end px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
        ...
        <div class="flex items-center space-x-4">
            ...
            <div class="flex items-center space-x-4">
                <a href="#" class="text-white hover:text-gray-400">MM</a>
                <span>|</span>
                <a href="#" class="text-white hover:text-gray-400">ENG</a>
            </div>
